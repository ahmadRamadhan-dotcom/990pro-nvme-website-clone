    ...
    <div class="grid place-content-center place-items-center">
      ...
      >
        ...
        >
          ...
          Higher performance usually consumes more power.
          <br class="hidden sm:hidden md:block lg:block" />
          But, 990 PRO uses less power with over 50% improved performance per
          Watt over 980 PRO. This low-power design makes max PCIe<sup>®</sup>4.0
          performance possible with optimal power efficiency.
        </span>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          <span class="text-[12px] font-normal font-['SamsungOne']"
            >990 PRO Sequential Read/Write - 1380/1319 MB/Watt based on internal
            test result of the 1TB capacity model.
          </span>
        </div>
        <img
