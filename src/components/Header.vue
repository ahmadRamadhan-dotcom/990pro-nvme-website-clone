  ...
  <header class="w-full sticky top-0 z-[30] bg-black flex justify-center">
    <div class="w-full grid">
      <div class="flex justify-center">
        <div
          class="w-10/12 sm:w-11/12 xl:w-[93%] py-4 sm:py-4 xl:py-0 xl:pt-1.5 flex justify-between items-center sm:flex sm:justify-between sm:items-center"
        >
      ...
      <div class="flex justify-center xl:mt-1.5">
        <div
          class="w-10/12 sm:w-11/12 xl:w-[93%] py-3 sm:py-3 xl:py-0 flex justify-between sm:flex sm:justify-between sm:items-center xl:flex xl:justify-between xl:items-center"
        >
          <div
