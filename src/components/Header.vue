  ...
  <div class="w-full bg-black flex justify-center">
    <div class="w-full grid">
      <div class="flex justify-center">
        <div
          class="w-10/12 sm:w-[600px] md:w-11/12 lg:w-[950px] xl:w-[1300px] py-4 sm:py-4 xl:py-0 xl:pt-1.5 flex justify-between items-center sm:flex sm:justify-between sm:items-center"
        >
          <div class="xl:flex xl:items-center xl:gap-2">
            ...
            />
            <LeftList :leftData="leftData" />
          </div>
          <FullList :fullData="fullData" />
      ...
      <div class="flex justify-center xl:mt-1.5">
        <div
          class="w-10/12 sm:w-[600px] md:w-11/12 lg:w-[950px] py-3 sm:py-3 xl:py-0 xl:w-[1300px] flex justify-between sm:flex sm:justify-between sm:items-center xl:flex xl:justify-between xl:items-center"
        >
          <div
          ...
          <CenterListBottom :centerData="centerData" />
          <div class="">
            <a
              href="#_"
...
import CenterListBottom from "./CenterListBottom.vue";
import CenterListBottomSmallDevices from "./CenterListBottomSmallDevices.vue";
const centerData = [
  { id: 1, name: "Overview" },
  { id: 2, name: "Specifications" },
  { id: 3, name: "Download Files" },
];
const leftData = [
  { id: 1, name: "Products" },
  { id: 2, name: "Foundry" },
...
const fullData = [...leftData, ...rightData];
</script>
